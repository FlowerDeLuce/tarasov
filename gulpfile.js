...
gulp.task('js', function () {
    return gulp.src(['./dev/js/0_jquery-3.2.1.min.js', './dev/js/5-timer.js', './dev/js/1-slick.js', './dev/js/2-jquery.maskedinput.js', './dev/js/3-jquery.validate.js', './dev/js/6-formvalidation.js', './dev/js/7-script.js'])
        .pipe(concat('bild.js'))
        .pipe(uglify())
        .pipe(gulp.dest('dist/js'));
